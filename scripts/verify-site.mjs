...
const requiredText = [
  ...
  "Navigate the right commercial real estate <em>decision.</em>",
  "Experience matters. Principles decide how it is used.",
  "Guided Reach",
  "Circle K",
  ...
  "Current opportunities, viewed with <em>context.</em>",
  "Property Inventory",
  ...
  "assets/favicon.ico",
  "assets/premium-convenience-editorial.jpg",
  "assets/premium-investment-editorial.jpg",
  "assets/premium-retail-editorial.jpg",
  "assets/premium-convenience-editorial.jpg",
  "assets/premium-management-editorial.jpg",
  "assets/premium-loan-editorial.jpg",
  "assets/premium-advisory-editorial.jpg",
  "assets/hero-gas-convenience-2026.jpg",
  "assets/hero-multifamily-2026.jpg",
  "assets/hero-office-industrial-2026.jpg",
  "assets/hero-retail-2026.jpg",
  "assets/premium-advisory-editorial.jpg",
  "assets/hero-gas-convenience-2026.jpg",
  "assets/hero-multifamily-2026.jpg",
  "assets/hero-office-industrial-2026.jpg",
  "assets/hero-retail-2026.jpg",
  "assets/service-context-investment.jpg",
  "assets/service-context-seller.jpg",
  "assets/service-context-buyer.jpg",
  "assets/service-context-landlord.jpg",
  "assets/service-context-tenant.jpg",
  "assets/service-context-business.jpg",
  "assets/service-context-management.jpg",
  "assets/service-context-loan.jpg",
  "hero-slide",
  "Vision",
  "Fun",
  "commercial real estate advice should be candid, cooperative, and personal.",
  "How Max Works",
  ...
  "Property Types &amp; Market Data",
  "Lease &amp; Portfolio Performance",
  "Guiding Principles",
  "Personal advice. Ethical practice. Focused attention.",
...
const expectedPageTitles = {
  ...
  "business-broker.html": "Business Broker | Magellan CRE",
...
for (const asset of [
  "assets/premium-hero-editorial.jpg",
  "assets/premium-convenience-editorial.jpg",
  "assets/premium-investment-editorial.jpg",
  "assets/premium-retail-editorial.jpg",
  "assets/premium-convenience-editorial.jpg",
