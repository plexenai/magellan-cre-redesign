...
const requiredText = [
  ...
  "assets/favicon.ico",
  "assets/max-hero-aerial-clean.jpg",
  "assets/max-highway-frontage-clean.jpg",
  "assets/max-investment-sales-clean.jpg",
  "assets/max-strip-center-clean.jpg",
  "assets/max-gas-station-clean.jpg",
  "assets/max-property-management-clean.jpg",
  "assets/max-loan-packaging-clean.jpg",
  "assets/max-business-broker-clean.jpg",
  "assets/max-team-advisory-clean.jpg",
  "hero-slide",
  "Vision",
  "Fun",
